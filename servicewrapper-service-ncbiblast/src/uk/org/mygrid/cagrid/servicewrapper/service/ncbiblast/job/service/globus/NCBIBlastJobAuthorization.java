 ...
 * 
 */
public class NCBIBlastJobAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://www.mygrid.org.uk/2009/cagrid/servicewrapper/service/NCBIBlast/Job";
	
	Map authorizationClassMap = new HashMap();
	
	
	public NCBIBlastJobAuthorization() {
	}
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getError")){
