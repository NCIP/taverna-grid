 ...
 * 
 */
public class InterproScanWrappedJobAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "gme://Taverna-caGrid.caBIG/1.0/uk.org.mygrid.cagrid.service.interproscan/Job";
	
	Map authorizationClassMap = new HashMap();
	
	
	public InterproScanWrappedJobAuthorization() {
	}
	...
	public void authorizeGetOutput(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getStatus")){
			authorizeGetStatus(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("getOutput")){
			authorizeGetOutput(peerSubject, context, operation);
			return true;
