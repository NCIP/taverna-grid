...
/**
 * Dialog for entering user's CaGrid username and password.
 * 
 * @author Alex Nenadic
 */
@SuppressWarnings("serial")
public class GetCaGridPasswordDialog
    extends JDialog
{
    ...
    // Whether user wished to save the username and password
    ...
    // Name of the CaGrid, e.g Training or Production
	private String caGridName;

    /**
     * Creates new NewEditPasswordEntryDialog dialog where parent is a frame.
     */
    public GetCaGridPasswordDialog(String caGridName)
    {
        super((Frame)null, "Username and password for " +  caGridName, true);      
    ...
    private void initComponents()
    {
        ...
        JLabel jlInstructions = new JLabel("Enter username and password to obtain a proxy for " + caGridName);
        ...
        // Central panel with username/password fields and a "Save?" checkbox
