...
public class AddCaGridTransferTemplateAction extends AbstractContextualMenuAction {

	private static final URI serviceTemplatesSection = URI
	.create("http://taverna.sf.net/2009/contextMenu/serviceTemplates");
	
	private static Logger logger = Logger.getLogger(AddCaGridTransferTemplateAction.class);

	public AddCaGridTransferTemplateAction(){
	...
	protected Action createAction() {
		AbstractAction action = new AbstractAction("Add caGrid Transfer Activity", ActivityIconManager.getInstance()
