...
public class NCBIBlastJobResourceHome extends ResourceHomeImpl {
	...
	public ResourceKey createResource() throws Exception {
		...
		NCBIBlastJobResource resource = (NCBIBlastJobResource) createNewInstance();
		// Create the resource properties bean so that the resource can use it to hold the  resource property values
		NCBIBlastJobResourceProperties props = new NCBIBlastJobResourceProperties();
        ...
        resource.initialize(props, NCBIBlastJobConstants.RESOURCE_PROPERTY_SET, id);
 	...
 	*/
	public uk.org.mygrid.cagrid.servicewrapper.service.ncbiblast.job.stubs.types.NCBIBlastJobReference getResourceReference(ResourceKey key) throws Exception {
		...
		uk.org.mygrid.cagrid.servicewrapper.service.ncbiblast.job.stubs.types.NCBIBlastJobReference ref = new uk.org.mygrid.cagrid.servicewrapper.service.ncbiblast.job.stubs.types.NCBIBlastJobReference();
 	...
 	*/	
	public NCBIBlastJobResource getResource(ResourceKey key) throws ResourceException {
		NCBIBlastJobResource thisResource = (NCBIBlastJobResource)find(key);
		return thisResource;
	}
     ...
     */
    public NCBIBlastJobResource getAddressedResource() throws Exception {
        NCBIBlastJobResource thisResource;
