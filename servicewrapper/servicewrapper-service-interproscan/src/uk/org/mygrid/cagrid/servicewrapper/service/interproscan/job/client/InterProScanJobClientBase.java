...
import uk.org.mygrid.cagrid.servicewrapper.service.interproscan.job.stubs.InterProScanJobPortType;
import uk.org.mygrid.cagrid.servicewrapper.service.interproscan.job.stubs.service.InterProScanJobServiceAddressingLocator;
 ...
 */
public abstract class InterProScanJobClientBase extends ServiceSecurityClient implements NotifyCallback {	
	protected InterProScanJobPortType portType;
	...
	public InterProScanJobClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public InterProScanJobClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected InterProScanJobPortType createPortType() throws RemoteException {

		InterProScanJobServiceAddressingLocator locator = new InterProScanJobServiceAddressingLocator();
		...
		InterProScanJobPortType port = null;
		try {
			port = locator.getInterProScanJobPortTypePort(getEndpointReference());
		} catch (Exception e) {
