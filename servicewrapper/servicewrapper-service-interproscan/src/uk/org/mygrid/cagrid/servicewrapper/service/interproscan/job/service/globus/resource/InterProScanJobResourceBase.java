...
public abstract class InterProScanJobResourceBase extends ReflectionResource implements Resource
	...
	public void setTerminationTime(Calendar time) {
		...
		Topic terminationTopic = ((Topic)getResourcePropertySet().get(InterProScanJobConstants.TERMINATIONTIME));
	...
	public uk.org.mygrid.cagrid.domain.interproscan.InterProScanInput getInterProScanInput(){
		return ((InterProScanJobResourceProperties) getResourceBean()).getInterProScanInput();
	}
	...
	public uk.org.mygrid.cagrid.domain.interproscan.InterProScanOutput getInterProScanOutput(){
		return ((InterProScanJobResourceProperties) getResourceBean()).getInterProScanOutput();
	}
	...
	public gov.nih.nci.cagrid.metadata.service.Fault getFault(){
		return ((InterProScanJobResourceProperties) getResourceBean()).getFault();
	}
	...
	public InterProScanJobResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (InterProScanJobResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
