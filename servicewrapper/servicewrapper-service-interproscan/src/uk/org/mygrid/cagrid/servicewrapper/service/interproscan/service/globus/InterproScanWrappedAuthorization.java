 ...
 * 
 */
public class InterproScanWrappedAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "gme://Taverna-caGrid.caBIG/1.0/uk.org.mygrid.cagrid.service.interproscan";
	
	Map authorizationClassMap = new HashMap();
	
	
	public InterproScanWrappedAuthorization() {
	}
