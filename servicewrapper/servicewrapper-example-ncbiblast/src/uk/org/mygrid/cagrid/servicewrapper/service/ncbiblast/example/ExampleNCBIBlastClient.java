package uk.org.mygrid.cagrid.servicewrapper.service.ncbiblast.example;
...
public class ExampleNCBIBlastClient {

	private String url = "http://cagrid.taverna.org.uk:8080/wsrf/services/cagrid/NCBIBlast";
	private static final int TIMEOUT_SECONDS = 5*60; // 5 minutes
	
	public static void usage(){
		System.out.println(ExampleNCBIBlastClient.class.getName() + " -url <service url>");
	}

	public static void main(String[] args) throws Exception {
		    System.out.println("Running NCBI Blast client");
		    ExampleNCBIBlastClient exampleClient = new ExampleNCBIBlastClient();
