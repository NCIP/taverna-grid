 ...
 */
public abstract class InterProScanClientBase extends ServiceSecurityClient {	
	protected InterProScanPortType portType;
	...
	public InterProScanClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public InterProScanClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected InterProScanPortType createPortType() throws RemoteException {

		InterProScanServiceAddressingLocator locator = new InterProScanServiceAddressingLocator();
		...
		InterProScanPortType port = null;
		try {
			port = locator.getInterProScanPortTypePort(getEndpointReference());
		} catch (Exception e) {
