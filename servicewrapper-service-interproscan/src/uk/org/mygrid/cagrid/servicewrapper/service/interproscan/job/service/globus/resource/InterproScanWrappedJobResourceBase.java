 ...
 * 
 */
public abstract class InterproScanWrappedJobResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  ,RemoveCallback
                                                  {

	static final Log logger = LogFactory.getLog(InterproScanWrappedJobResourceBase.class);

	private InterproScanWrappedJobResourceConfiguration configuration;
    ...
    public InterproScanWrappedJobResourceBase() {
    }
	...
	public InterProScanOutput getInterProScanOutput(){
		return ((InterproScanWrappedJobResourceProperties) getResourceBean()).getInterProScanOutput();
	}
	
	public void setInterProScanOutput(InterProScanOutput interProScanOutput ) throws ResourceException {
		ResourceProperty prop = getResourcePropertySet().get(InterproScanWrappedJobConstants.INTERPROSCANOUTPUT);
	...
	public Error getError(){
		return ((InterproScanWrappedJobResourceProperties) getResourceBean()).getError();
	}
	
	public void setError(Error error ) throws ResourceException {
		ResourceProperty prop = getResourcePropertySet().get(InterproScanWrappedJobConstants.ERROR);
		prop.set(0, error);
	}
	...
	public InterproScanWrappedJobResourceConfiguration getConfiguration() {
		...
		servicePath+="/InterproScanWrappedJob";
		...
		try {
			...
			this.configuration = (InterproScanWrappedJobResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
