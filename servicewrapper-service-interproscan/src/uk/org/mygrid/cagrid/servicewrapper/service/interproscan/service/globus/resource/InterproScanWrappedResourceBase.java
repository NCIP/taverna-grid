...
import uk.org.mygrid.cagrid.servicewrapper.service.interproscan.common.InterproScanWrappedConstants;
import uk.org.mygrid.cagrid.servicewrapper.service.interproscan.stubs.InterproScanWrappedResourceProperties;
 ...
 * 
 */
public abstract class InterproScanWrappedResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(InterproScanWrappedResourceBase.class);

	private InterproScanWrappedResourceConfiguration configuration;
    ...
    public InterproScanWrappedResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((InterproScanWrappedResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(InterproScanWrappedConstants.SERVICEMETADATA);
	...
	public InterproScanWrappedResourceConfiguration getConfiguration() {
		...
		servicePath+="/InterproScanWrapped";
		...
		try {
			...
			this.configuration = (InterproScanWrappedResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
	...
	private void loadServiceMetadataFromFile() {
      if(getServiceMetadata()==null){
		try {
			...
			((InterproScanWrappedResourceProperties) this.getResourceBean()).setServiceMetadata((gov.nih.nci.cagrid.metadata.ServiceMetadata) Utils.deserializeDocument(dataFile.getAbsolutePath(),
