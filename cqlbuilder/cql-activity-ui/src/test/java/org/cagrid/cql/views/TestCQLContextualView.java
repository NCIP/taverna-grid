...
import org.cagrid.cql.views.CQLActivityContextualView;
import org.junit.Before;
import org.junit.Test;

public class TestCQLContextualView {
	Activity<?> activity;
	
	@Before
	public void setup() throws ActivityConfigurationException {
		activity=new CQLActivity();
		CQLConfigurationBean b=new CQLConfigurationBean();
		b.setValue("elvis");
	...
	public void testGetConfigureAction() throws Exception {
		ContextualView view = new CQLActivityContextualView(activity);
		assertNotNull("The action should not be null",view.getConfigureAction(null));
		assertTrue("Should be a StringConstantActivityConfigurationAction",view.getConfigureAction(null) instanceof CQLActivityConfigurationAction);
	}
