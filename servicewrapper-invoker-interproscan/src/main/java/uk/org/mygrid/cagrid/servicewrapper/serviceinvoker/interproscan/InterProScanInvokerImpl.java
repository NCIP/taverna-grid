...
public class InterProScanInvokerImpl implements InterProScanInvoker {
	...
	private static Logger logger = Logger.getLogger(InterProScanInvokerImpl.class);

	private WSInterProScanServiceStub interProScan;

	private SAXBuilder saxBuilder = new SAXBuilder();
	
	public InterProScanInvokerImpl() throws InvokerException {
		try {
