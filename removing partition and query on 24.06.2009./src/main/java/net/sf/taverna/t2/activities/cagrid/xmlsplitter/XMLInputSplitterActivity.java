...
import net.sf.taverna.cagrid.wsdl.xmlsplitter.XMLInputSplitter;
import net.sf.taverna.cagrid.wsdl.xmlsplitter.XMLSplitterSerialisationHelper;
...
public class XMLInputSplitterActivity extends AbstractAsynchronousActivity<XMLSplitterConfigurationBean> implements InputPortTypeDescriptorActivity {
	...
	// Configure colour for XMLInputSplitterActivity
	static{
		ColourManager.getInstance().setPreferredColour("net.sf.taverna.t2.activities.cagrid.xmlsplitter.XMLInputSplitterActivity", new Color(0xab92ea));
	}
